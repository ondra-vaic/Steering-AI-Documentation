...
A **Steering System** is a Unity [`System`](https://https://docs.unity3d.com/Packages/com.unity.entities@1.3/manual/systems-overview.html) which derives from [`BaseSteeringSystem`](/docs/documentation-core/base-system/BaseSteeringSystem). There will typically be one implementation of [`BaseSteeringSystem`](/docs/documentation-core/base-system/BaseSteeringSystem) per one [entity tag](/docs/documentation-core/components/Tags). [`BaseSteeringSystem`](/docs/documentation-core/base-system/BaseSteeringSystem) is responsible for scheduling and synchornizing parallel [Jobs](https://docs.unity3d.com/Manual/job-system.html) which determine behavior of all entities with same **Main Tag**. See diagram below for details on how the [Jobs](https://docs.unity3d.com/Manual/job-system.html) are scheduled.  

In short, [`BaseSteeringSystem`](/docs/documentation-core/base-system/BaseSteeringSystem) loads a [`SteeringSystemAsset`](/docs/documentation-core/base-system/SteeringSystemAsset) at a given path and then runs all of the system's [**Behaviors**](/docs/category/behaviors) for all entities in the scene which have the corresponding **Main Tag** assigned. Then, the results of behaviors are passed into a [**Combiner**](/docs/documentation-core/combiner), which combines all behaviors' results into a single final [**Desired Velocity**](/docs/documentation-defaults/Combiner#desiredvelocitycomponent) which the entity wants to travel at. This is later given to the [**Movement System**](/docs/category/movement). The [Jobs](https://docs.unity3d.com/Manual/job-system.html) are run for all entities in parallel indendent of each other.  
