...
7. The editor lists which components are missing on the entity. Click plus next to [`DesiredVelocityComponent`](/docs/documentation-defaults/Combiner#desiredvelocitycomponent) to add it to the prefab. 
