...
Simple behaviors are implementations of `ISimpleBehaviorJobWrapper`. The `BaseSystem` schedules them after querying the entities with the main entity query.
