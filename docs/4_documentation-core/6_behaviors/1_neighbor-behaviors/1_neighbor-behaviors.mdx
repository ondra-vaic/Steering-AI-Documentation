...
class DebugNeighborsJobWrapper : INeighborBehaviorJobRunner
{
...
This job wrapper uses two attributes. First declares what type of object the behavior returns. Second declares which components are expected on the entity and it's neighbor. The types from the attributes are used in the editor of the [`SteeringSystemAsset`](/docs/documentation-core/base-system/SteeringSystemAsset). 
...
- `C1` - *type of component on the main entities implements [`INeighborBaseBehavior`](/docs/documentation-core/components/INeighborBaseBehavior) - must match the first argument of [`[JobWrapper]`](/docs/documentation-core/attributes#jobwrapperattribute)*
- `C2` - *type of component on the neighbors - should match the second argument of [`[JobWrapper]`](/docs/documentation-core/attributes#jobwrapperattribute)*
- `A` - *type of accumulator passed into the `Exectute` method, implements [IAccumulator](/docs/documentation-core/behaviors/accumulators)*
