...
- `C1` - *type of component expected on the main entities - should match the first argument of [`[JobWrapper]`](/docs/documentation-core/attributes#jobwrapperattribute)*
- `C2` - *type of component expected on the neighbors - should match the second argument of [`[JobWrapper]`](/docs/documentation-core/attributes#jobwrapperattribute)*
