...
Instance of `SteeringSystemAsset` is what is loaded by the [`BaseSteeringSystem`](/docs/documentation-core/base-system/BaseSteeringSystem) and defines it's behavior. The system is defined declaratively from queries and behaviors. 
