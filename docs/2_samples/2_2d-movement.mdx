...
<Tabs>
  <TabItem value="first" label="Scene"> 
    There are three copies of the *Movement2DEntity* prefab in the scene. Each entity has a different values changed on it's `Movement2DAuthoring` relative to the original.
