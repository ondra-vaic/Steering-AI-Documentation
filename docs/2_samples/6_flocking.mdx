...
<Tabs>
  ...
  <TabItem value="third" label="Prefab"> 
    ...
    **Other Components**:
    ...
    :::note
    It does not matter that the scenes use a different prefab than what is referenced in *FlockingBehaviorsSteeringAsset*, as long as they use `_6_SampleBehaviorsTagComponent`.
    :::
